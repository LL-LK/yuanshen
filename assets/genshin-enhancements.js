...
(function() {
  ...
  function initBackToTop() {
    ...
    if (!btn) {
      ...
      btn.style.cssText = 'background-color: var(--genshin-primary); color: var(--genshin-primary-foreground); box-shadow: 0 4px 20px rgba(0,0,0,0.4); border: none; cursor: pointer;';
